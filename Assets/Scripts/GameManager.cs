...
public class GameManager : MonoBehaviour
{
    ...
    public void CompleteQualityPotion()
    {
        ...
        Debug.Log($"Poción de calidad completada! Total: {qualityPotionsCompleted}");
    }
    ...
    void UpdateDebugInfo()
    {
        ...
        info += $"Energía: {energyBarSystem.GetEnergyPercentage():F1}%";
        info += $"Penalización de tiempo: +{energyBarSystem.GetTimePenalty()}s";
    ...
    {
        inventorySystem.AñadirSemilla(PlantaTipo.Lumina, 10);
        inventorySystem.AñadirSemilla(PlantaTipo.Eldebria, 10);
        inventorySystem.AñadirSemilla(PlantaTipo.Jiveria, 10);
        inventorySystem.AñadirSemilla(PlantaTipo.Lirien, 10);
    }
...
// Script adicional para botones de UI rápida
public class QuickActionButtons : MonoBehaviour
{
    ...
    public void BuySeedsLumina()
    {
        ...
        {
            InventorySystem.Instance.AñadirSemilla(PlantaTipo.Lumina, 1);
        }
    }
}