...
public class ElegirPocion : MonoBehaviour
{
    ...
    public void SeleccionarPocion(PocionSO pocion)
    {
        ...
        // antes de verificar, sync (InventorySystem -> InventoryManager)
        SyncCalderoInventoryDesdeInvernadero();
    ...
    {
        Debug.Log("[ELEGIR POCIÓN] Verificando ingredientes...");
        ...
        if (pocion.suero != null && !HasItem1(pocion.suero)) faltantes.Add(pocion.suero.itemNombre);
        if (pocion.ingrediente1 != null && !HasItem1(pocion.ingrediente1)) faltantes.Add(pocion.ingrediente1.itemNombre);
        if (pocion.ingrediente2 != null && !HasItem1(pocion.ingrediente2)) faltantes.Add(pocion.ingrediente2.itemNombre);
