...
public class InvernaderoManagerOld : MonoBehaviour
{
    public static InvernaderoManagerOld Instance { get; private set; }

    public PlantData currentParcelaPlant = null;
    ...
    void Start()
    {
        ...
        Debug.Log("InvernaderoManagerOld inicializado");
    }
